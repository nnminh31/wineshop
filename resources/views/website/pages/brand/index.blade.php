    ...
    <div class="wrapper">
        <div class="container">
            <div class="row">
                        ...
                        <aside id="secondary" class="widget-area">
                            <section id="woocommerce_product_search-4" class="widget woocommerce widget_product_search">
                                ...
                                <form role="search" method="get" class="woocommerce-product-search" action="{{route('search')}}">
                                    ...
                                    <input type="search" id="woocommerce-product-search-field-0" class="search-field" placeholder="Từ khóa" value="" name="s">
                                ...
                                <form action="{{route('search')}}" method="get">
                                    <div class="filter-box">
                                        ...
                                        <div class="filter">
                                            ...
                                            ?>>Thương hiệu <i class="fa fa-angle-down"></i></h3>

                                            <div class="item-filt" <?php 
                                                if ($brand->count() > 0) {
                                            ...
                                            ?>>
                                                ...
                                                <label>
                                                @if ($br->id == $brand->id)
                                                    <span><a href="{{route('brand', $br->slug)}}" style="color: #800020">{{$br->name}}</a></span>
                                                    @else
                                                    <span><a href="{{route('brand', $br->slug)}}">{{$br->name}}</a></span>
                                                    @endif
                                                </label>
                                                @endforeach
                                            </div>
                ...
                <div class="col-md-9">
                    <h1 class="title-page" style="text-transform: uppercase;">{{$brand->name}}</h1>
                    <div class="sort-page">
                        <div class="row">
