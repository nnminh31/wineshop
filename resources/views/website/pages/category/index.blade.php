    ...
    <div class="wrapper">
        <div class="container">
            <div class="row">
                                ...
                                <form action="{{route('search')}}" method="get">
                                    <div class="filter-box">
                                        ...
                                        <div class="filter">
                                            ...
                                            ?>>Danh mục <i class="fa fa-angle-down"></i></h3>
                                            ...
                                            ?>>
                                                ...
                                                <label>
                                                    ...
                                                    <span><a href="{{route('category', $cat->slug)}}" style="color: #800020">{{$cat->name}}</a></span>
                                                    @else
                ...
                <div class="col-md-9">
                    <h1 class="title-page" style="text-transform: uppercase;">{{$category->name}}</h1>
                    <div class="sort-page">
                        <div class="row">
